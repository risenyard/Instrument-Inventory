...
namespace INSTRUMENT
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ///
            if (this.textBox1.Text != "" && this.textBox2.Text != "" && this.textBox3.Text != "" && this.textBox4.Text!=""&& comboBox1.Text!=""
                && comboBox2.Text != "" && comboBox3.Text != "" && comboBox4.Text != "" && comboBoxSpecies.Text != "")
            {
                //添加乐器属性
                data = new List<object> {this.textBox1.Text, this.textBox2.Text };
                Builder_Enum flag1;
                Enum.TryParse<Builder_Enum>(comboBox1.Text, true, out flag1);
                data.Add(flag1);
                data.Add(this.textBox4.Text);
                Type_Enum flag2;
